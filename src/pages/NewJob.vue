<script setup lang="ts">
  ...
  const billableItems = ref<BillableItem[]>([
    ...
    // { id: 'POLY_ONLY_SMALL', label: 'Poly Only', description: 'Discuss with Pawel on job-to-job basis $25.00 (small)', model: ref(false), type: 'toggle' },
    // { id: 'POLY_ONLY_LARGE', label: 'Poly Only', description: 'Discuss with Pawel on job-to-job basis $50.00 (large)', model: ref(false), type: 'toggle' },
    { id: 'SUITED_MECH_ROOM_RES_BAR', label: 'Suited Mech Room', description: ' Res Bar Installation (Common Walls) $65.00/install ', model: ref(false), type: 'toggle' },
